                                                                    ...
                                                                    <div class="col-sm-6" id="XDescripcion">
                                                                        <div class="form-group form-float">
                                                                            <div class="form-line">
                                                                                ...
                                                                                <label class="form-label">Descripción de la categoría de producto</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <select class="form-control show-tick" id="cboTipoServicio" name="cboTipoServicio"></select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>                                                          .
