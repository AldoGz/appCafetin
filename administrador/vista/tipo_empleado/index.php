                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-8">
                                    <h2>Formulario de tipo de empleado</h2>
                                </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form name="frm-grabar" id="frm-grabar"  role="form">
                                                    <div class="modal-body">
                                                        <input type="hidden" id="intCodigoTipoEmpleado" name="intCodigoTipoEmpleado" class="form-control">
                                                                    ...
                                                                    <div class="col-sm-12" id="XDescripcion">
                                                                        <div class="form-group form-float">
                                                                            <div class="form-line">
                                                                                ...
                                                                                <label class="form-label">Descripción de la tipo de empleado</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
