                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-8">
                                    <h2>Formulario de serie comprobante</h2>
                                </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form name="frm-grabar" id="frm-grabar"  role="form">
                                                    <div class="modal-body">
                                                        <input type="hidden" id="codigo_serie_comprobante" name="codigo_serie_comprobante" class="form-control">
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-sm-12">
                                                                <div class="row clearfix">
                                                                    <div class="col-sm-6">
                                                                        <select class="form-control show-tick" id="cboTipoComprobante" name="cboTipoComprobante"></select>
                                                                    </div>
                                                                    <div class="col-sm-6" id="XDescripcion">
                                                                        <div class="form-group form-float">
                                                                            <div class="form-line">
                                                                                <input type="text" id="numeroCorrelativo" name="numeroCorrelativo" class="form-control">
