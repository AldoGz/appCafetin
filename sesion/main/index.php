...
<body class="text-center">
    <form class="form-signin">
        ...
        <input type="text" id="txtusuario" class="form-control" placeholder="Usuario" required="" autofocus="" maxlength="8">
        <br>
        <label for="txtclave" class="sr-only">Contraseña</label>
        <input type="password" id="txtclave" class="form-control" placeholder="Contraseña" required="">
        <br>
