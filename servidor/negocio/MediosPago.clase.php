...
class MediosPago extends Conexion {
    ...
    public function agregar() {
        ...
        try {            
            ...
            $this->insert("medios_pago", $campos_valores);
            $this->commit();
    ...
    public function editar() {
        ...
        try { 
            ...
            $this->update("medios_pago", $campos_valores,$campos_valores_where);
            $this->commit();
    ...
    public function leerDatos() {
        try {
            $sql = "SELECT * FROM medios_pago WHERE id =:0";
    ...
    public function llenarCB() {
        try {
            $sql = "SELECT * FROM medios_pago WHERE estado = 1";
