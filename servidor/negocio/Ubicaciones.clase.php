...
class Ubicaciones extends Conexion {
    ...
    public function agregar() {
        ...
        try {            
            ...
            $this->insert("ubicaciones", $campos_valores);
            $this->commit();
    ...
    public function editar() {
        ...
        try { 
            ...
            $this->update("ubicaciones", $campos_valores,$campos_valores_where);
            $this->commit();
    ...
    public function listar() {
        try {
            $sql = "SELECT * FROM ubicaciones WHERE estado = :0";
    ...
    public function leerDatos() {
        try {
            $sql = "SELECT * FROM ubicaciones WHERE id =:0";
    ...
    public function llenarCB() {
        try {
            $sql = "SELECT * FROM ubicaciones WHERE estado = 1";
